...
IMAGE_PATH = DATA_PATH / "image.i.VAST_0334-37.SB50801.cont.taylor.0.restored.conv.fits"
"""Path: Path to random VAST epoch 38 image for testing purposes. 
"""

REFERENCE_PATH = (
    DATA_PATH / "image.i.VAST_0345-31.SB50802.cont.taylor.0.restored.conv.fits"
)
"""Path: Path to random VAST epoch 38 image for header information in testing
the function add_degenerate_axes().
"""

WEIGHTS_PATH = DATA_PATH / "weights.i.VAST_0334-37.SB50801.cont.taylor.0.fits"
